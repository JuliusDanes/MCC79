...
namespace API.Services
{
    public class AuthService
    {
        ...
        private readonly MCC79DbContext _MCC79DbContext;

        public AuthService(IAccountRepository accountRepository, IEmployeeRepository employeeRepository, IUniversityRepository universityRepository, IEducationRepository educationRepository, ITokenHandler tokenHandler, IAccountRoleRepository accountRoleRepository, IRoleRepository roleRepository, IEmailHandler emailHandler, MCC79DbContext MCC79DbContext)
        {
            ...
            _MCC79DbContext = MCC79DbContext;
        }
        ...
        {
            using var transaction = _MCC79DbContext.Database.BeginTransaction();
            try
            {
